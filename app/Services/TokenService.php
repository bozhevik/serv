...
use Carbon\Carbon;//  библиотека для работы с датами и временем
...
class TokenService
{
    ...
    {
        $accessTokenExpiresAt = Carbon::now()->addMinutes((int)env('TOKEN_LIFETIME', 15));
    ...
    public function refreshAccessToken($refreshToken)
    {
        ...
        $newAccessExpiresAt = Carbon::now()->addMinutes((int)env('TOKEN_LIFETIME', 30));
